...
export const TRANSLATIONS: Record<Language, TranslationSchema> = {
  en: {
    ...
    orderSuccess: '🎇 Celebration Confirmed! Your order has been recorded and sent directly to our WhatsApp sales line.',
  ...
  ta: {
    ...
    placeOrder: 'உறுதிசெய்து வாட்ஸ்அப்பில் ஆர்டர் செய்க',
    orderSuccess: '🎇 கொண்டாட்டம் உறுதியானது! உங்கள் ஆர்டர் பதிவு செய்யப்பட்டு எங்களது வாட்ஸ்அப் எண்ணிற்கு உடனடியாக அனுப்பப்பட்டது.',
